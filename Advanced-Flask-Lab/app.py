...
posts = {
    "static/images/fulls/04.jpg": "2021 cohort's Y3 Accelerator!",
    "static/images/fulls/05.jpg": "MEET graduation!",
    "static/images/fulls/06.jpg": "#Throwback to one of our favorite #MEETsummer events: #BowlingNight!",
    "static/images/fulls/07.jpg": "2020 cohort in their Y1 summer!"}
...
def home():
    return render_template('index.html', image=image_link, bio=user_bio, posts=posts, pol=posts.keys()[::3])
